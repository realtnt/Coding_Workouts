...
colour_options = ["Red", "Gold", "Blue", "Yellow",
                  "Silver", "Black", "Pink", "White", "Brown", "Purple"]
animal_options = ["Avocado", "Badger", "Cat", "Rabbit", "Dolphin", "Velociraptor", "Mouse",
                  "Hamster", "Hawk", "Eagle", "Slug", "Tortoise", "Dog", "Pigeon", "Unicorn", "Horse"]
adjective_options = ["Amazing", "Brainless", "Bonny", "Charming", "Delightful",
                     "Scrawny", "Dirty", "Powerful", "Sorry", "Unstoppable", "Terrible"]
adjective2_options = ["Hyper", "Super", "Uber",
                      "Ultra", "Mega", "Micro", "Mini", "Crazy"]
...
box1.bg = colour1
message1 = Text(box1, text="Choose a prefix:", size=12,
                font="Arial Black", align="left")
cmb_adjective2 = Combo(box1, options=adjective2_options,
                       selected="Super", width=11, height=3, align="right")
cmb_adjective2.font = "Arial Black"
cmb_adjective2.text_size = 12

box2 = Box(app, width="fill")
box2.bg = colour2
message2 = Text(box2, text="Choose an adjective:",
                size=12, font="Arial Black", align="left")
cmb_adjective = Combo(box2, options=adjective_options,
                      selected="Amazing", width=11, height=3, align="right")
cmb_adjective.font = "Arial Black"
cmb_adjective.text_size = 12

box3 = Box(app, width="fill")
box3.bg = colour3
message3 = Text(box3, text="Pick a colour:", size=12,
                font="Arial Black", align="left")
cmb_colour = Combo(box3, options=colour_options,
                   selected="Black", width=11, height=3, align="right")
cmb_colour.font = "Arial Black"
cmb_colour.text_size = 12

box4 = Box(app, width="fill")
box4.bg = colour4
message4 = Text(box4, text="Pick an animal:", size=12,
                font="Arial Black", align="left")
cmb_animal = Combo(box4, options=animal_options,
                   selected="Aardvark", width=11, height=3, align="right")
cmb_animal.font = "Arial Black"
cmb_animal.text_size = 12

box5 = Box(app, width="fill")
box5.bg = colour5
name = Text(box5, text="What is your name?", size=12,
            font="Arial Black", height=3, align="left")
txtbox_name = TextBox(box5, width=14, align="right")
txtbox_name.text_size = "16"

check_random = CheckBox(app, text="Randomise",
                        command=toggle_controls, height=3, width="fill")
...
box6.bg = colour7
lbl_pressbutton = Text(box6, text="Press the button below\nto get your hero name:",
                       height=3, width="fill", size=14, font="Arial Black")
btn_make_name = PushButton(
    box6, text="Make me a hero!", command=make_hero_name)
btn_make_name.disable()
btn_make_name.font = "Arial Black"
btn_make_name.text_size = 12

lbl_output = Text(app, text="You are...", height=1,
                  width="fill", size=24, font="Impact")
lbl_name = Text(app, text=" ", height=1, width="fill", size=20, font="Impact")
lbl_herooutput = Text(app, text=" ", color=cmb_colour.value,
                      height=1, width="fill", size=20, font="Impact")
